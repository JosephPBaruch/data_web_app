...
app.get('/results', (req, res) =>{
    fetch('http://localhost:3500/results?number=' + req.query.number + '&street=' + req.query.street + '&type=' + req.query.type + '&city=' + req.query.city + '&state=' + req.query.state ) //'http://localhost:3500/results?number=2840&street=Tanglerose&type=Place&city=Eagle&state=ID' ) 
         .then(res => {
